...
const guiState = {
  algorithm: "single-pose", // change default to single pose
  input: {
...
function detectPoseInRealTime(video, net) {
  ...
  async function poseDetectionFrame() {
    ...
    // push to poses bank for evaluation if button is clicked
    poses_bank.push(poses);
...
/**
 * evaluate if the workout pose is correct
 */
...
export async function bindPage() {
  ...
  // add start button
  var start_div = document.getElementById("workout_button");
